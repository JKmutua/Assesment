        ...
        <div class="col-span-3">
          <div class="grid grid-cols-3 gap-4">
            ...
            >
              ...
              <div class="space-y-2">
                ...
                <div
                  class="text-3xl font-extrabold text-gray-700 dark:text-gray-100"
                >
                  3,956
                </div>
            ...
            >
              ...
              <div class="space-y-2">
                ...
                <div
                  class="flex items-center space-x-1 rtl:space-x-reverse text-sm font-medium text-red-500"
                >
                  <span>32k decrease</span>
          ...
          >
            <div class="flex flex-1 me-1">
              ...
              >
                <span class="">Customer registration trends</span>
          ...
          >
            <div class="flex flex-1 me-1">
              ...
              <div
                class="flex flex-col text-sm text-gray-500 dark:text-gray-400"
              >
                <span class="">Budgeting Insights</span>
                <small class="font-regular">Refresh to update</small>
              </div>
            </div>
          ...
          >
            <div class="flex flex-1 me-1">
              ...
              <div
                class="flex flex-col text-sm text-gray-500 dark:text-gray-400"
              >
                <span class="">Goal Setting Insights</span>
                <small class="font-regular">Refresh to update</small>
              </div>
            </div>
            <div class="flex justify-center items-center">
